...
const LogedIn = (props) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    fill="currentColor"
    className="admin__icon bi bi-person-check-fill"
    viewBox="0 0 16 16"
  >
    <path
      fill="evenodd"
...
const DashBoard = (props) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    fill="currentColor"
    className="icon bi bi-grid-3x3-gap-fill"
    viewBox="0 0 16 16"
  >
...
const CheckMark = (props) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    fill="currentColor"
    className="success__icon bi bi-check-circle-fill"
    viewBox="0 0 16 16"
  >
...
const Access = (props) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    fill="currentColor"
    className="success__icon bi bi-eye-slash-fill"
    viewBox="0 0 16 16"
  >
...
const Wifi = (props) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    fill="currentColor"
    className="icon__spec bi bi-wifi"
    viewBox="0 0 16 16"
  >
...
const Cup = (props) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    fill="currentColor"
    className="icon__spec bi bi-cup"
    viewBox="0 0 16 16"
  >
...
const Location = (props) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    fill="currentColor"
    className="icon__spec bi bi-geo"
    viewBox="0 0 16 16"
  >
    <path
      fillRule="evenodd"
